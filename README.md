...
<img width="1193" height="178" alt="Screenshot 2026-07-12 125747" src="https://github.com/user-attachments/assets/8c038869-057b-40b0-a615-c84a60dbc2f2" />
...
On 22 April 2026, an investigation was initiated after a finance user reported repeated overnight login prompts on workstation npt-ws01, indicating possible unauthorized access. Analysis confirmed that the workstation was compromised through misuse of the helpdesk account from an external IP address, followed by remote execution of a malicious file, outbound communication to an external command-and-control domain, creation of multiple persistence mechanisms, and the addition of an unauthorized local administrator account. Evidence also indicated possible activity extending toward a second host, npt-srv01, expanding the scope of concern beyond a single endpoint. 

The incident created risk of continued unauthorized access, persistence within the environment, misuse of privileged credentials, and potential lateral movement to additional systems. Immediate response priorities included isolating affected hosts, disabling and resetting compromised accounts, removing attacker-created access and persistence artifacts, and blocking known malicious indicators associated with the activity. 

At the time of reporting, the investigation had established a confirmed endpoint compromise with indicators of broader exposure requiring continued review of related systems, accounts, and authentication activity. This summary is intended to support management awareness, response coordination, and containment decision-making. 
